  ...
  Welcomescreen = function (slides, options) {
    ...
    var self = this,
      ...
      defaults = {
        ...
        closeButtonText : 'Cerrar', // close button text
        ...
        parallaxBackgroundImage: 'https://miayotlan.com/miayotlan/img/logo-miayotlan.png', // parallax default background image
