(function() {
    ...
    var xb = /^[\w+/_-]+[=]{0,2}$/,
        Lb = function() {
            var a = l.document.querySelector("script[nonce]");
            if (a && (a = a.nonce || a.getAttribute("nonce")) && xb.test(a)) return a
        };
    var y = function(a) {
            try {
                var b;
        ...
        Sb = /^(-?[0-9.]{1,30})$/,
        Tb = function(a) {
            return Sb.test(a) && (a = Number(a), !isNaN(a)) ? a : null
        },
        Ub = function(a, b) {
            return b ? !/^false$/.test(a) : /^true$/.test(a)
        },
        Vb = function(a) {
            return (a = Rb.exec(a)) ? +a[1] : null
        };
    var Wb = function() {
            return "r20180102"
        },
    ...
    var bc = x("Opera"),
        cc = -1 != rb.toLowerCase().indexOf("webkit") && !x("Edge");
    var dc = function(a) {
    ...
    var kc = Object.prototype.hasOwnProperty,
        lc = function(a, b) {
            for (var c in a) kc.call(a, c) && b.call(void 0, a[c], c, a)
        },
        mc = function(a) {
        ...
        qc = !!window.google_async_iframe_id,
        rc = qc && window.parent || window,
        sc = function() {
            if (qc && !y(rc)) {
                var a = "." + Na.domain;
                try {
                    for (; 2 < a.split(".").length && !y(rc);) Na.domain = a = a.substr(a.indexOf(".") + 1), rc = window.parent
                } catch (b) {}
                y(rc) || (rc = window)
            }
            return rc
        ...
        tc = /(^| )adsbygoogle($| )/,
        uc = function(a) {
            a = Xb && a.google_top_window || a.top;
            return y(a) ? a : null
        };
    var B = function(a, b) {
            a = a.google_ad_modifications;
            return oc(a ? a.eids || [] : [], b)
        },
        C = function(a, b) {
            a = a.google_ad_modifications;
            return oc(a ? a.loeids || [] : [], b)
        },
        vc = function(a, b, c) {
            if (!a) return null;
    ...
    var yc = x("Safari") && !((x("Chrome") || x("CriOS")) && !x("Edge") || x("Coast") || x("Opera") || x("Edge") || x("Silk") || x("Android")) && !(x("iPhone") && !x("iPod") && !x("iPad") || x("iPad") || x("iPod"));
    var zc = null,
        Ac = null,
        Bc = x("Gecko") && !(-1 != rb.toLowerCase().indexOf("webkit") && !x("Edge")) && !(x("Trident") || x("MSIE")) && !x("Edge") || cc && !yc || bc || "function" == typeof l.btoa,
        Cc = function(a, b) {
            if (!zc) {
                zc = {};
                Ac = {};
                for (var c = 0; 65 > c; c++) zc[c] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c), Ac[c] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(c)
            }
            b = b ? Ac : zc;
            c = [];
    ...
    var Dc = function() {},
        ...
        Gc = function(a, b, c) {
            ...
            a: {
                if (a.l.length) {
                    b = a.l.length - 1;
                    var d = a.l[b];
                    if (d && "object" == typeof d && "array" != u(d) && !(Ec && d instanceof Uint8Array)) {
                        a.v = b - a.s;
                        a.o = d;
                        break a
                    }
            ...
            if (c)
                for (b = 0; b < c.length; b++)
                    if (d = c[b], d < a.v) d += a.s, a.l[d] = a.l[d] || Fc;
                    else {
                        var e = a.v + a.s;
                        a.l[e] || (a.o = a.l[e] = {});
                        a.o[d] = a.o[d] || Fc
        ...
        D = function(a, b) {
            ...
            if (a.o) return c = a.o[b], c === Fc ? a.o[b] = [] : c
        },
        Hc = function(a, b) {
            if (b < a.v) {
                b += a.s;
        ...
        bd = function(a, b, c) {
            a.j || (a.j = {});
            if (!a.j[c]) {
                for (var d = Hc(a, c), e = [], f = 0; f < d.length; f++) e[f] = new b(d[f]);
                a.j[c] = e
            }
            b = a.j[c];
            b == Fc && (b = a.j[c] = []);
        ...
        cd = function(a) {
            if (a.j)
                for (var b in a.j) {
                    var c = a.j[b];
                    if ("array" == u(c))
                        for (var d = 0; d < c.length; d++) c[d] && cd(c[d]);
                    else c && cd(c)
                }
        };
    ...
    var pd = /^https?:\/\/(\w|-)+\.cdn\.ampproject\.(net|org)(\?|\/|$)/,
        qd = function(a, b) {
            this.j = a;
            this.l = b
        },
    ...
    var sd = function() {
        ...
        ud = function(a, b, c, d, e) {
            ...
            if (a instanceof Array) {
                if (d = d || 0, d < c.length) {
                    for (var f = [], g = 0; g < a.length; g++) f.push(ud(a[g], b, c, d + 1, e));
                    return f.join(c[d])
                }
    ...
    var zd = function(a, b, c, d, e, f) {
        if ((d ? a.v : Math.random()) < (e || a.j)) try {
            if (c instanceof sd) var g = c;
            else g = new sd, Pb(c, function(a, b) {
                var c = g,
                    d = c.v++;
                a = td(b, a);
                c.j.push(d);
            ...
            var h = yd(g, a.s, a.l, a.o + b + "&");
            h && ("undefined" === typeof f ? jc(h, void 0) : jc(h, f))
        } catch (k) {}
    };
    var Ad = function(a, b) {
        this.start = a < b ? a : b;
    ...
    var Dd = !1,
        ...
        Gd = function(a, b) {
            var c;
            c = (c = Fd()) ? (c = c.match(new RegExp("\\b(" + a.join("|") + ")\\b"))) ? c[0] : null : null;
            if (c) a = c;
            else if (Dd) a = null;
            else a: {
    ...
    var F = l.performance,
        Kd = !!(F && F.mark && F.measure && F.clearMarks),
        Ld = function(a) {
            var b = !1,
                c;
            return function() {
        ...
        Nd = function() {
            ...
            this.j = Ld() || (null != b ? b : 1 > Math.random())
        },
        Od = function(a) {
            a && F && Ld() && (F.clearMarks("goog_" + a.uniqueId + "_start"), F.clearMarks("goog_" + a.uniqueId + "_end"))
        };
    Nd.prototype.start = function(a, b) {
    ...
    var Rd = function() {
        ...
        Ud = function(a, b, c, d, e) {
            try {
                ...
                h = a.s;
                try {
                    Od(f), h = (e || a.J).call(a, b, new Sd(Td(n), n.fileName, n.lineNumber), void 0, d)
                } catch (v) {
                    a.j(217, v)
                }
                if (!h) throw n;
        ...
        Vd = function(a, b) {
            ...
            return function(d) {
                ...
                return Ud(c, a, function() {
                    return b.apply(void 0, e)
                }, void 0, void 0)
            }
        };
    Rd.prototype.j = function(a, b, c, d, e) {
        e = e || "jserror";
        try {
            var f = new sd;
            f.s = !0;
            wd(f, 1, "context", a);
            b.error && b.meta && b.id || (b = new Sd(Td(b), b.fileName, b.lineNumber));
            b.msg && wd(f, 2, "msg", b.msg.substring(0, 512));
            b.file && wd(f, 3, "file", b.file);
            0 < b.line && wd(f, 4, "line", b.line);
            var g = b.meta || {};
            if (this.o) try {
                this.o(g)
            } catch (L) {}
            ...
            var v = new rd(l.location.href, l, !1);
            m = null;
            var r = b.length - 1;
            for (n = r; 0 <= n; --n) {
                var p = b[n];
            ...
            0 != v.depth && t && (p = b[r]);
            var A = new qd(v, p);
            A.l && wd(f, 6, "top", A.l.url || "");
            wd(f, 7, "url", A.j.url || "");
            zd(this.B, e, f, this.v, c)
        } catch (L) {
            try {
                zd(this.B, e, {
                    context: "ecmserr",
    ...
    var Qd, G, Md = sc(),
        Pd = new Nd,
        Wd = function(a) {
            null != a && (Md.google_measure_js_timing = a);
            Md.google_measure_js_timing || (a = Pd, a.j = !1, a.events != a.l.google_js_reporting_queue && (Ld() && Ua(a.events, Od), a.events.length = 0))
        };
    Qd = new function() {
        var a = void 0 === a ? w : a;
    ...
    G = new Rd;
    "complete" == Md.document.readyState ? Wd() : Pd.j && fc(Md, "load", function() {
        Wd()
    });
    var Zd = function() {
            var a = [Xd, Yd];
    ...
    var Ae = {
        ...
        Ce = function() {
            ...
            a = a.substring(0, b);
            if (Be.test(a)) return !1;
            a = a.split(".");
            b = !1;
            3 <= a.length && (b = a[a.length - 3] in Ae);
            2 <= a.length && (b = b || a[a.length - 2] in Ae);
            return b
        };
    var I = function(a) {
        a = a.document;
    ...
    var Se = function(a, b) {
        ...
        Ue = function(a, b) {
            ...
            try {
                ...
                var d = c ? new ze(c ? JSON.parse(c) : null) : null
            } catch (g) {
                d = null
            }
            if (c = null !== d) d = D(d, 2), c = null == d ? !1 : d;
            ...
            for (d = 0; d < c.length; d++) {
                ...
                if (1 == D(e, 8)) {
                    var f = ad(e, gd, 4);
                    if (f && 2 == D(f, 1) && Te(a, e, b)) return a.l = !0, a = a.j.google_ama_state = a.j.google_ama_state || {}, a.placement = d, !0
                }
            }
            return !1
        },
        Te = function(a, b, c) {
            ...
            if (!d) return !1;
            var e = D(d, 7);
            if (D(d, 1) || D(d, 3) || 0 < Hc(d, 4).length) {
                var f = D(d, 3),
                    g = D(d, 1),
                    h = Hc(d, 4);
                e = D(d, 2);
                ...
                f && (m += "#" + Ie(f));
                if (h)
                    for (f = 0; f < h.length; f++) m += "." + Ie(h[f]);
                e = (h = m) ? new Ee(h, e, k, d) : null
            } else e = e ? new Ee(e, D(d, 2), D(d, 5), Me(D(d, 6))) : null;
            if (!e) return !1;
            k = [];
            try {
            ...
            if (!(h = null == k)) {
                ...
                c = !(c && (1 != c.nodeType || "INS" != c.tagName || !Je(c)) && 0 >= c.offsetWidth);h = !c
            }
            if (h) return !1;
            b = ad(b, fd, 3);
            h = {};
            b && (h.la = D(b, 1), h.$ = D(b, 2), h.va = !!D(b, 3));
            var n;
            b = a.j;
            c = a.o;
            d = a.v;
        ...
        try {
            switch (this.l.document.readyState) {
                ...
                case "interactive":
                    ...
                    break;
                default:
                    Ue(this.o, !1) ? af(this) : this.l.setTimeout(Da(this.s, this), 100)
            }
        } catch (a) {
            af(this, a)
        }
    ...
    var fg = function(a) {
            var b = hf(),
                c = eg(a, cg, J(b, 71), J(b, 72), ["153762914", "153762975"]),
                d = "";
            ...
            c = eg(a, cg, J(b, 71) + J(b, 72), J(b, 80), ["164692081", "165767636"]);
        ...
        gg = function(a) {
            ...
            if (!b.plle) {
                ...
                K(c, f.ha);
                f = fe;
                var g = eg(a, jf, J(e, 84), J(e, 85), [f.m, f.u]);
                K(b, g);
                var h = ee;
                g == f.m ? d = h.m : g == f.u ? d = h.u : d = "";
                K(c, d);
                f = ie;
                K(c, eg(a, lf, J(e, 9), J(e, 10), [f.m, f.V]));
                ab("") && K(b, "");
                f = me;
                ...
                K(c, f);
                f || (f = qe, f = M(a, J(e, 58), [f.m, f.u]), K(c, f));
                f || (f = te, g = M(a, J(e, 56), [f.m, f.u]), K(c, g));
                f = je;
                ...
                K(c, g);
                g == ke.w && (f = le, g = M(a, J(e, 66), [f.w, f.m]), K(c, g));
                f = pe;
                g = eg(a, kf, J(e, 14), J(e, 15), [f.m, f.A]);
                K(b, g);
                h = oe;
                g == f.m ? d = h.m : g == f.A ? d = h.A : d = "";
                K(c, d);
                f = se;
                g = eg(a, dg, J(e, 54), J(e, 55), [f.m, f.D, f.F, f.C]);
                K(b, g);
                h = re;
                ...
                K(c, d);
                if (Ub(e.j[77], !1) || Xb) f = ue, g = M(a, J(e, 76), [f.m, f.Y, f.M, f.X]), K(c, g), g || (g = M(a, J(e, 83), [f.W]), K(c, g));
                f = ve;
        ...
        M = function(a, b, c) {
            for (var d = 0; d < c.length; d++)
                if (hg(a, c[d])) return c[d];
            return Gd(c, b)
        },
        eg = function(a, b, c, d, e) {
            for (var f = 0; f < e.length; f++)
                if (hg(a, e[f])) return e[f];
            f = new Ad(c, c + d - 1);
            (d = 0 >= d || d % e.length) || (b = b.j, d = !(b.start <= f.start && b.j >= f.j));
            d ? c = null : (a = Cd(a), c = null !== a && f.start <= a && f.j >= a ? e[(a - c) % e.length] : null);
            return c
        };
    var ig = function(a) {
        if (!a) return "";
    ...
    var jg = function(a, b, c) {
        ...
        var e = ["<iframe"],
            f;
        for (f in a) a.hasOwnProperty(f) && nc(e, f + "=" + a[f]);
    ...
    var P = [new O(970, 90, 2), new O(728, 90, 2), new O(468, 60, 2), new O(336, 280, 1), new O(320, 100, 2), new O(320, 50, 2), new O(300, 600, 4), new O(300, 250, 1), new O(250, 250, 1), new O(234, 60, 2), new O(200, 200, 1), new O(180, 150, 1), new O(160, 600, 4), new O(125, 125, 1), new O(120, 600, 4), new O(120, 240, 4)],
        og = [P[6], P[12], P[3], P[0], P[7], P[14], P[1], P[8], P[10], P[4], P[15], P[2], P[11], P[5], P[13], P[9]],
        pg = new O(120, 120, 1, !0),
        qg = new O(120, 50, 2, !0);
    ...
    var sg = function(a, b) {
        ...
        ug = function(a) {
            var b = 0,
                c;
            for (c in lg) - 1 != a.indexOf(c) && (b |= lg[c]);
            return b
        },
        vg = function(a, b) {
            for (var c = I(b).clientWidth, d = 0; 100 > d && a; d++) {
                var e = z(a, b);
                if (e && "hidden" == e.overflowX && (e = Vb(e.width)) && e < c) return !0;
                a = a.parentElement
            }
            return !1
        },
        wg = function(a, b, c, d, e) {
            e = e || {};
            if ((Xb && a.google_top_window || a.top) != a) return e.google_fwr_non_expansion_reason = 3, !1;
            ...
            return !f || (f - c) / f > d ? (e.google_fwr_non_expansion_reason = 6, !1) : vg(b.parentElement, a) ? (e.google_fwr_non_expansion_reason = 7, !1) : !0
        },
        xg = function(a) {
        ...
        Ag = function(a, b, c, d, e, f) {
            if (a = z(c, a)) {
                ...
                a = g.ga;
                g = g.ba;
                f.google_ad_resize ? c = -1 * (g + a) + "px" : (c = xg(c) + a, c = "rtl" == d ? -1 * (g - c) + "px" : -1 * c + "px");
    ...
    var Bg = function(a, b, c) {
        ...
        Dg = function(a, b) {
            return sg(a, b) < I(b).clientHeight - 100
        },
        Gg = function(a, b) {
            var c = Infinity;
            do {
                var d = Bg(b, a, "height");
                d && (c = Math.min(c, d));
                (d = Bg(b, a, "maxHeight")) && (c = Math.min(c, d))
        ...
        Hg = function(a, b) {
            ...
            if (c) return c;
            c = Infinity;
            do(d = b.style && Vb(b.style.height)) && (c = Math.min(c, d)), (d = Bg(b, a, "maxHeight")) && (c = Math.min(c, d)); while ((b = b.parentElement) && "HTML" != b.tagName);
            return c
        },
        Eg = function(a) {
            var b = a.google_unique_id;
            return C(a, pe.A) && 0 == ("number" === typeof b ? b : 0) ? 2 * I(a).clientHeight / 3 : 250
        };
    var Ig = /^(\d+)x(\d+)(|_[a-z]*)$/,
        Jg = function(a) {
    ...
    Q.prototype.na = function(a, b) {
        0 != this.j || 0 != this.s.length || b && b != window ? this.v(a, b) : (this.j = 2, this.J(new Lg(a, window)))
    };
    Q.prototype.v = function(a, b) {
        this.s.push(new Lg(a, b || this.l));
        Mg(this)
    };
    Q.prototype.pa = function(a) {
        this.j = 1;
        if (a) {
            var b = ae(188, Da(this.B, this, !0));
    ...
    var Ng = function(a) {
        ...
        Og = function(a) {
            return !!a && ("object" === typeof a || "function" === typeof a) && Ng(a) && mc(a.nq) && mc(a.nqa) && mc(a.al) && mc(a.rl)
        },
        Pg = function() {
            if (Kg && Ng(Kg)) return Kg;
            var a = de(),
                b = a.google_jobrunner;
            return Og(b) ? Kg = b : a.google_jobrunner = Kg = new Q(a)
        },
        Qg = function(a, b) {
            Pg().nq(a, b)
        },
    ...
    ma(S, Error);
    var Ug = function(a) {
        return 0 == (a.error && a.meta && a.id ? a.msg || Td(a.error) : Td(a)).indexOf("TagError")
    };
    var Vg = function() {
    ...
    var Yg = function(a, b, c, d, e) {
            ...
            a = $d(247, be, function() {
                ...
                if (h != f) {
                    ...
                    k && (e.gfwroml = d.style.marginLeft, e.gfwromr = d.style.marginRight, e.gfwrow = d.style.width, e.gfwroz = d.style.zIndex, Ag(c, d, k, f, h, e), f = h)
                }
                return f
            });
            return Xg(a, b, c, d, e, f != a)
        },
        Wg = function(a, b, c, d, e) {
            e.google_full_width_responsive_allowed = !1;
            if ("false" == e.google_full_width_responsive && !Zg(c)) return e.google_fwr_non_expansion_reason = 1, a;
            if (!("auto" == b || 0 < (ug(b) & 3) && (Zg(c) || C(c, fe.u) || C(c, fe.m))) && 1 != e.google_ad_resize) return e.google_fwr_non_expansion_reason = 2, a;
            if (!wg(c, d, a, .3, e)) return a;
            var f = I(c).clientWidth,
                g = f - a;
            if (!f || 5 > g) return e.google_fwr_non_expansion_reason = f ? -10 > g ? 11 : 0 > g ? 14 : 0 == g ? 13 : 12 : 10, a;
            if (!$g(d, c, e)) return e.google_fwr_non_expansion_reason = 9, a;
            e.google_full_width_responsive_allowed = !0;
            return "auto" == b || 0 < (ug(b) & 3) && (Zg(c) || C(c, fe.u)) ? f : (e.google_fwr_non_expansion_reason = 15, a)
        },
        Xg = function(a, b, c, d, e, f) {
            var g = "auto" == b ? .25 >= a / Math.min(1200, I(c).clientWidth) ? 4 : 3 : ug(b);
            e.google_responsive_formats = g;
            var h = Vg() && !Dg(d, c) && $g(d, c, e),
                k = Vg() && Dg(d, c) && (C(c, pe.A) || C(c, pe.m)) && $g(d, c, e) && C(c, pe.A),
                m = (h ? og : P).slice(0);
            m = Va(m, ah(c));
            var n = 488 > I(c).clientWidth;
            n = [Cg(a), bh(n), Fg(n, c, d), mg(g)];
            var v = [function(a) {
                return !a.xa
            }];
            if (h || k) {
                var r = h ? Gg(c, d) : Hg(c, d);
                v.push(function(a) {
                    return a.height() <= r
                })
            }
            var p = Tg(m, Sg(n), Sg(v));
            ...
            p = $d(248, be, function() {
                a: {
                    ...
                    if (f) {
                        ...
                        if (Dg(d, c)) b = new ng(a, b.height());
                        else {
                            b = a / 1.2;
                            g = Gg(c, d);
                            g = Math.min(b, g);
                            if (g < .5 * b || 100 > g) g = b;
                            b = new ng(a, Math.floor(g))
                        }
                    }
                }
                return b
            });
            return new R(ch(b, g), p)
        },
        $g = function(a, b, c) {
            var d = c.google_safe_for_responsive_override;
            return null != d ? d : c.google_safe_for_responsive_override = tg(a, b)
        },
        ch = function(a, b) {
            if ("auto" == a) return 1;
            switch (b) {
        ...
        ah = function(a) {
            var b = [],
                c = C(a, se.C);
            (C(a, se.D) || c) && b.push(pg);
            (C(a, se.F) || c) && b.push(qg);
            return b
        };
    var dh = ["google_content_recommendation_ui_type", "google_content_recommendation_columns_num", "google_content_recommendation_rows_num"],
        T = {},
        eh = (T.image_stacked = 1 / 1.91, T.image_sidebyside = 1 / 3.82, T.mobile_banner_image_sidebyside = 1 / 3.82, T.pub_control_image_stacked = 1 / 1.91, T.pub_control_image_sidebyside = 1 / 3.82, T.pub_control_image_card_stacked = 1 / 1.91, T.pub_control_image_card_sidebyside = 1 / 3.74, T.pub_control_text = 0, T.pub_control_text_card = 0, T),
        U = {},
        fh = (U.image_stacked = 80, U.image_sidebyside = 0, U.mobile_banner_image_sidebyside = 0, U.pub_control_image_stacked = 80, U.pub_control_image_sidebyside = 0, U.pub_control_image_card_stacked = 85, U.pub_control_image_card_sidebyside = 0, U.pub_control_text = 80, U.pub_control_text_card = 80, U),
        gh = {},
        hh = (gh.pub_control_image_stacked = 100, gh.pub_control_image_sidebyside = 200, gh.pub_control_image_card_stacked = 150, gh.pub_control_image_card_sidebyside = 250, gh.pub_control_text = 100, gh.pub_control_text_card = 150, gh),
        ih = function(a, b) {
            N.call(this, a, b)
        };
    ma(ih, N);
    ...
    function kh(a) {
        return 1200 <= a ? new ih(1200, 600) : 850 <= a ? new ih(a, Math.floor(.5 * a)) : 550 <= a ? new ih(a, Math.floor(.6 * a)) : 468 <= a ? new ih(a, Math.floor(.7 * a)) : new ih(a, Math.floor(3.44 * a))
    }
    ...
    var ph = [new V(728, 15), new V(468, 15), new V(200, 90), new V(180, 90), new V(160, 90), new V(120, 90)];
    var qh = function(a) {
        var b = a.google_ad_format;
        if ("autorelaxed" == b) return jh(a) ? 9 : 5;
    ...
    var th = function(a, b) {
        ...
        vh = jb("var i=this.id,s=window.google_iframe_oncopy,H=s&&s.handlers,h=H&&H[i],w=this.contentWindow,d;try{d=w.document}catch(e){}if(h&&d&&(!d.body||!d.body.firstChild)){if(h.call){setTimeout(h,0)}else if(h.match){try{h=s.upd(h,i)}catch(e){}w.location.replace(h)}}");
    var wh = {
            '"': '\\"',
            "\\": "\\\\",
            "/": "\\/",
        ...
        xh = /\uffff/.test("\uffff") ? /[\\"\x00-\x1f\x7f-\uffff]/g : /[\\"\x00-\x1f\x7f-\xff]/g,
        yh = function() {},
        Ah = function(a, b, c) {
            switch (typeof b) {
                case "string":
                ...
                case "object":
                    ...
                    if (b instanceof Array || void 0 != b.length && b.splice) {
                        var d = b.length;
                        c.push("[");
                        for (var e = "", f = 0; f < d; f++) c.push(e), Ah(a, b[f], c), e = ",";
                        c.push("]");
                        break
                    }
                    c.push("{");
                    d = "";
                    for (e in b) b.hasOwnProperty(e) && (f = b[e], "function" != typeof f && (c.push(d), zh(e, c), c.push(":"), Ah(a, f, c), d = ","));
                    c.push("}");
                    break;
                case "function":
                    break;
        ...
        zh = function(a, b) {
            b.push('"');
            b.push(a.replace(xh, function(a) {
                if (a in wh) return wh[a];
                var b = a.charCodeAt(0),
                    c = "\\u";
                16 > b ? c += "000" : 256 > b ? c += "00" : 4096 > b && (c += "0");
                return wh[a] = c + b.toString(16)
            }));
            b.push('"')
        };
    var Bh = {},
        Ch = (Bh.google_ad_modifications = !0, Bh.google_analytics_domain_name = !0, Bh.google_analytics_uacct = !0, Bh),
        Dh = function(a) {
            try {
                if (l.JSON && l.JSON.stringify && l.encodeURIComponent) {
                    ...
                    try {
                        var f = Bc ? l.btoa(e) : Cc(xc(e), void 0)
                    } catch (g) {
                        f = "#" + Cc(xc(e), !0)
                    }
    ...
    var Hh = function() {
        ...
        Jh = function(a) {
            if (2 != Ih(a)) {
                for (var b = 1 == Ih(a), c = 0; c < a.o.length; c++) try {
                    a.o[c](b)
                } catch (d) {}
                a.o = []
            }
        ...
        Mh = function(a) {
            ...
            b.o.push(a);
            if (2 != b.j) Jh(b);
            else if (b.s || (fc(b.l, "message", function(a) {
                    var c = Fh(b.l);
                ...
                a = (new dc(b.l.document)).j.createElement("IFRAME");
                a.src = b.v;
        ...
        Fh = function(a) {
            return a.frames && a.frames[wb("detect_3p_cookie")] || null
        },
        Gh = function(a) {
            return Nh(a, "3p_cookie_yes") ? 1 : Nh(a, "3p_cookie_no") ? 0 : 2
        };
    var Oh = function(a, b, c, d, e) {
        d = void 0 === d ? "" : d;
        var f = a.createElement("link");
        f.rel = c; - 1 != c.toLowerCase().indexOf("stylesheet") ? b = $a(b) : b instanceof Za ? b = $a(b) : b instanceof ob ? b instanceof ob && b.constructor === ob && b.ta === nb ? b = b.P : (u(b), b = "type_error:SafeUrl") : (b instanceof ob || (b = b.da ? b.O() : String(b), pb.test(b) || (b = "about:invalid#zClosurez"), b = qb(b)), b = b.O());
        f.href = b;
        d && "preload" == c && (f.as = d);
        e && (f.nonce = e);
    ...
    var Ph = /^\.google\.(com?\.)?[a-z]{2,3}$/,
        Qh = /\.(cn|com\.bi|do|sl)$/,
        Rh = function(a) {
            return Ph.test(a) && !Qh.test(a)
        },
        Sh = l,
        Lh, Th = function(a) {
        ...
        W, X, Uh = function() {
            Sh = l;
            W = Sh.googleToken = Sh.googleToken || {};
            var a = +new Date;
            W[1] && W[3] > a && 0 < W[2] || (W[1] = "", W[2] = -1, W[3] = -1, W[4] = "", W[6] = "");
            X = Sh.googleIMState = Sh.googleIMState || {};
            Rh(X[1]) || (X[1] = ".google.com");
            "array" == u(X[5]) || (X[5] = []);
                ...
                if (!Y.N()) {
                    var a = l.document,
                        b = function(b) {
                            ...
                            c.src = $a(b);
                            try {
                                (a.head || a.body || a.documentElement).appendChild(c), Y.za()
                            } catch (h) {}
                        },
                        c = X[1];
                    b(c);
        ...
        Wh = function(a) {
            l.processGoogleToken = l.processGoogleToken || function(a, c) {
                ...
                if (m || e || n) e = +new Date, f = e + 1E3 * f, g = e + 1E3 * g, 1E-5 > Math.random() && jc("https://pagead2.googlesyndication.com/pagead/gen_204?id=imerr&err=" + c, void 0), k[5] = c, k[1] = a, k[2] = f, k[3] = g, k[4] = h, k[6] = b, Uh();
                if (m || !Y.N()) {
                    c = Y.ca();
    ...
    var Z = wb("script"),
        $h = function() {
            ...
            (B(w, H.u) || B(w, H.L) || b) && !w.google_sa_queue && (w.google_sa_queue = [], w.google_sl_win = w, w.google_sailm = !0, w.google_process_slots = function() {
                return Yh(w, !a)
            }, b = b ? Zh() : Zh("/show_ads_impl_single_load.js"), Oh(w.document, b, "preload", "script"), Nb(w.document, b))
        },
        Yh = ae(215, function(a, b) {
            var c = a.google_sa_queue,
                d = c.shift();
            "function" == u(d) && $d(216, be, d);
            c.length && (b ? a.setTimeout(function() {
                return Yh(a, b)
            }, 0) : Yh(a, b))
        }),
        ai = function(a) {
            return ["<", Z, ' src="', Zh(void 0 === a ? "/show_ads_impl.js" : a), '"></', Z, ">"].join("")
        },
        Zh = function(a) {
            ...
            return sh(d, ["/pagead/js/", Wb(), "/r20170110", a, ""].join(""), b)
        },
        bi = function(a, b, c, d) {
            return function() {
                var e = !1;
                ...
                try {
                    ...
                    k = de().google_jobrunner, Og(k) && k.rl()
                }
                e && (e = th("google_async_rrc", c), (new uh(a)).set(b, bi(a, b, e, !1)))
            }
        },
        ci = function(a) {
            var b = ["<iframe"];
        ...
        ei = function(a, b, c) {
            di(a, b, c, function(a, b, f) {
                ...
                16 == f.google_reactive_ad_format ? (f = a.createElement("div"), a = jg(b, d, e), f.innerHTML = a, c.appendChild(f.firstChild)) : (f = jg(b, d, e), c.innerHTML = f);
                return b.id
            })
        },
        di = function(a, b, c, d) {
            ...
            if (!q(b.google_reactive_sra_index) || !b.google_ad_unit_key) {
                ...
                (f = f.join()) && e.push(f);
                b.google_ad_unit_key = Qb(e.join(":")).toString();
                e = [];
                for (f = 0; c && 25 > f; ++f) {
                ...
                b.google_ad_dom_fingerprint = Qb(c + f.join()).toString()
            }
            r = Eh(b);
            p = Dh(b);
            var t;
            ...
            kg ? t = "" : (t = {
                style: "display:none"
            }, /[^a-z0-9-]/.test(b) ? t = "" : (t["data-ad-client"] = ig(b), t.id = "google_esf", t.name = "google_esf", t.src = sh(ac(), ["/pagead/html/", Wb(), "/r20170110/zrt_lookup.html#"].join("")), t = ci(t)));
            b = t;
            t = B(a, H.u) || B(a, H.L) || B(a, H.G) || B(a, H.H);
            c = B(a, H.G) || B(a, H.H) || B(a, qe.u);
            e = Ma;
            f = (new Date).getTime();
            a.google_t12n_vars = ef;
            g = a;
            g = ic(hc(g)) || g;
            g = g.google_unique_id;
            B(a, qe.u) ? (h = "<" + Z + ">window.google_process_slots=function(){window.google_sa_impl({iframeWin: window, pubWin: window.parent});" + ("};</" + Z + ">"), k = ai(), h += k) : h = B(a, H.m) ? ai("/show_ads_impl.js?" + H.m) : B(a, H.u) || B(a, H.L) ? "<" + Z + ">window.parent.google_sa_impl.call(" + ("this, window, document, location);</" + Z + ">") : B(a, H.G) || B(a, H.H) ? "<" + Z + ">window.parent.google_sa_impl({iframeWin: window, pubWin: window.parent});</" + Z + ">" : B(a, te.u) ? ai("/show_ads_impl_le.js") : B(a, te.m) ? ai("/show_ads_impl_le_c.js") : ai();
            ...
            b = a.document.getElementById(d) ? Qg : Rg;
            d = bi(a, d, r, !0);
            t ? (a.google_sa_queue = a.google_sa_queue || [], a.google_sa_impl ? d() : a.google_sa_queue.push(d)) : b(d)
        },
        fi = function(a, b) {
            var c = navigator;
            a && b && c && (a = a.document, b = ig(b), /[^a-z0-9-]/.test(b) || ((c = ab("r20160913")) && (c += "/"), Nb(a, sh("pagead2.googlesyndication.com", "/pub-config/" + c + b + ".js"))))
        };
    var gi = function(a, b, c) {
        for (var d = a.attributes, e = d.length, f = 0; f < e; f++) {
            ...
            if (/data-/.test(g.name)) {
                ...
                if (!b.hasOwnProperty(h)) {
                    var k = g.value,
                        m = {},
                        n = (m.google_reactive_ad_format = Qa, m.google_allow_expandable_ads = Ub, m),
                        v = n.hasOwnProperty(h) ? n[h](k, null) : k;
                    null === v || (b[h] = v)
                }
            }
        }
        if ((B(c, me.m) || B(c, me.VIEWPORT) && c.document && c.document.body) && !qh(b)) {
        ...
        if (!b.google_enable_content_recommendations || 1 != mf && 2 != mf) {
            ...
            if (nf) {
                ...
                a: {
                    var yb = b.google_ad_height || Bg(a, c, "height");
                    switch (nf) {
                        case 5:
                            lh(E, b);
                            if (E < Ta)
                                if (Vg()) {
                                    mh(b, "mobile_banner_image_sidebyside", 1, 12);
                                    ...
                                    var ca = new R(9, new ih(E, Math.floor(pf / 1.91 + 70) + Math.floor((pf * eh[qf] + fh[qf]) * rf + 8 * rf + 8)))
                                } else mh(b, "image_sidebyside", 1, 13), ca = new R(9, kh(E));
                            else mh(b, "image_stacked", 4, 2), ca = new R(9, kh(E));
                            break a;
                        case 9:
                            lh(E, b);
                            ...
                            for (var Ga, Mc = +zb[Kc], ti = hh[Ab], Ha = Mc; E / Ha < ti && 1 < Ha;) Ha--;
                        ...
                        case 4:
                            ...
                            var ui = Math.min(E, 1200),
                                vf = uf.height();
                            Oc = Math.max(vf, Oc);
                            var wf = (new R(10, new V(ui, Math.min(Oc, 15 == vf ? Cb : Bb)))).R,
                                vi = wf.minWidth(),
                                xf = wf.height();
                            15 <= yb && (xf = yb);
                            ca = new R(10, new V(vi, xf));
                            break a;
                        case 8:
                            b: {
                                var da = E,
                                ...
                                if ("in-article" == Ia) {
                                    var Ja = da;
                                    if ("false" != b.google_full_width_responsive && (C(c, he.I) || C(c, he.K) || C(c, he.m)) && wg(c, a, Ja, .2, b)) {
                                        var Pc = I(c).clientWidth;
                                        if (Pc)
                                            if (b.google_full_width_responsive_allowed = !0, C(c, he.m)) da = Ja;
                                            else {
                                                ...
                                                if (yf) {
                                                    d: for (var ra = a, zf = 0; 100 > zf && ra.parentElement; ++zf) {
                                                        for (var Af = ra.parentElement.childNodes, Qc = 0; Qc < Af.length; ++Qc) {
                                                            var Bf = Af[Qc];
                                                            if (Bf != ra && zg(c, Bf)) break d
                                                        }
                                                        ra = ra.parentElement;
                                                        ra.style.width = "100%";
                                                        ra.style.height = "auto"
                                                    }
                                                    Ag(c, a, yf, Ja, Pc, b);da = Pc
                                                }
                                                else da = Ja
                                            }
                                        else da = Ja
                                ...
                                if (250 > da) throw new S("Fluid responsive ads must be at least 250px wide: availableWidth=" + da);
                                var Ka = Math.min(1200, Math.floor(da));
                                if (yb && "in-article" != Ia) {
                                    var Rc = Math.ceil(yb);
                                    if (50 > Rc) throw new S("Fluid responsive ads must be at least 50px tall: height=" + Rc);
                                    ca = new R(11, new N(Ka, Rc))
                                } else {
                                    if ("in-article" != Ia) {
                                        var Cf = b.google_ad_layout_key;
                                        if (Cf) {
                                            var Df = "" + Cf;
                                            var wi = Math.pow(10, 3),
                                                Sc = Df.match(/([+-][0-9a-z]+)/g),
                                                Ef = Sc && Sc.length;
                                            if (Ef) {
                                                for (var Ff = [], Tc = 0; Tc < Ef; Tc++) Ff.push(parseInt(Sc[Tc], 36) / wi);
                                                var Gf = Ff
                                            } else Gf = null;
                                            var Uc = Gf;
                                            if (!Uc) throw new S("Invalid data-ad-layout-key value: " + Df);
                                            for (var xi = (Ka + -725) / 1E3, Hf = 0, If = 1, yi = Uc.length, Vc = 0; Vc < yi; Vc++) Hf += Uc[Vc] * If, If *= xi;
                                    ...
                                    ca = new R(11, "in-article" == Ia ? new oh(Ka, Kf) : new N(Ka, Kf))
                                }
                            }
                            break a
                    }
                ...
                var Lf = ca;
                var Mf = Lf ? Lf : Yg(E, b.google_ad_format, c, a, b);
                var Wc = Mf.R;
                b.google_ad_width = Wc.j(E);
                var zi = b.google_ad_height = Wc.height();
                a.style.height = zi + "px";
                ...
                if (!Sb.test(b.google_ad_width) && !Rb.test(a.style.width) || !Sb.test(b.google_ad_height) && !Rb.test(a.style.height)) {
                    var Db = z(a, c);
                    Db && (a.style.width = Db.width, a.style.height = Db.height, rg(Db, b));
                    b.google_ad_width || (b.google_ad_width = a.offsetWidth);
                    b.google_ad_height || (b.google_ad_height = a.offsetHeight);
                    b.google_loader_features_used = 256;
                    b.google_responsive_auto_format = hc(c) ? 14 : 12
                } else if (rg(a.style, b), !(b.google_ad_output && "html" != b.google_ad_output || 300 != b.google_ad_width || 250 != b.google_ad_height)) {
                    var Ai = a.style.width;
                    a.style.width = "100%";
                    var Bi = a.offsetWidth;
                    a.style.width = Ai;
                    b.google_available_width = Bi
                }
                if (C(c, "153762914") || C(c, "153762975") || C(c, "164692081") || Jg(c)) {
                        ...
                        if (Xc = Ig.test(Eb) || !Eb) {
                            ...
                            if (!(Yc = null == Fb)) {
                                var Of = I(Fb).clientWidth,
                                    Gb;
                                if (!(Gb = !(488 > Of && 320 < Of) || !(Fb.innerHeight >= Fb.innerWidth) || vg(ja, c))) a: {
                                    b: {
                            ...
                            if (ka) {
                                ...
                                if (Vf) {
                                    ...
                                    if (!(5 > Wf || .4 < Wf / ka)) {
                                        ...
                                        if (C(c, "164692081") || Jg(c)) a: {
                                            for (var ea = ja, Xf = 0; 100 > Xf && ea; Xf++) {
                                                var Kb = ea.style;
                                        ...
                                        var $f = -1 * (xg(ja) + Ci) + "px";
                                        if (C(c, "153762975") || Jg(c)) "rtl" == Di ? a.style.marginRight = $f : a.style.marginLeft = $f, a.style.width = ka + "px", a.style.zIndex = 2147483647;
                                        var ag = "",
                                        ...
                                        Jb && Jg(c) && 1.15 < Uf / ta && (sg(a, c) < I(c).clientHeight || (ta = Math.round(5 * ka / 6)));
                                        if (C(c, "153762975") || Jg(c)) b.google_ad_format = ka + "x" + ta + ag, b.google_ad_width = ka, b.google_ad_height = ta, a.style.height = ta + "px";
    ...
    var hi = !1,
        ...
        ki = !1,
        li = function(a) {
            return tc.test(a.className) && "done" != a.getAttribute("data-adsbygoogle-status")
        },
        ni = function(a, b) {
            var c = window;
        ...
        mi = function(a, b, c) {
            var d = sc();
            d.google_spfd || (d.google_spfd = gi);
            gi(a, b, c);
            if (!oi(a, b, c)) {
                if (b.google_reactive_ads_config) {
                    if (hi) throw new S("Only one 'enable_page_level_ads' allowed per page.");
                    hi = !0
                } else b.google_ama || pc(c);
                ji || (ji = !0, fi(c, b.google_ad_client));
                lc(Ch, function(a, d) {
                    b[d] = b[d] || c[d]
                });
                b.google_loader_used = "aa";
                b.google_reactive_tag_first = 1 === ii;
        ...
        oi = function(a, b, c) {
            ...
            !e || vc(e.ad_whitelist, g, f || b.google_tag_origin) ? e = null : (f = e.space_collapsing || "none", e = (g = vc(e.ad_blacklist, g)) ? {
                Z: !0,
            ...
            if (e && e.Z && "on" != b.google_adtest) return "slot" == e.ja && (null !== Tb(a.getAttribute("width")) && a.setAttribute("width", 0), null !== Tb(a.getAttribute("height")) && a.setAttribute("height", 0), a.style.width = "0px", a.style.height = "0px"), !0;
        ...
        pi = function(a) {
            for (var b = document.getElementsByTagName("ins"), c = 0, d = b[c]; c < b.length; d = b[++c]) {
                var e = d;
                if (li(e) && "reserved" != e.getAttribute("data-adsbygoogle-status") && (!a || d.id == a)) return d
            }
            return null
        },
        ri = function(a) {
            if (!ki) {
                ...
                try {
                    var c = b ? new kd(b ? JSON.parse(b) : null) : null
                } catch (A) {
                    c = null
                }
                if (b = c)
                    if (c = ad(b, ld, 3), !c || D(c, 1) <= +new Date) try {
                        ...
                        B(l, xe.u) || (v = qi(), l.document.documentElement.appendChild(v), p = {}, a = (p.google_ama = !0, p.google_ad_client = a, p), ni(v, a))
                    }
            }
        },
        qi = function() {
        ...
        Ei = function(a) {
            ...
            b.google_reactive_ads_global_state || (b.google_reactive_ads_global_state = new df);
            b.google_reactive_ads_global_state.wasPlaTagProcessed = !0;
            Na.body ? si(a) : fc(Na, "DOMContentLoaded", ae(191, function() {
                si(a)
            }))
        },
        Fi = function(a, b, c, d) {
            return Ug(b) ? (G.v = !0, G.j(a, b, .1, d, "puberror"), !1) : G.j(a, b, c, d)
        },
        Gi = function(a, b, c, d) {
            return Ug(b) ? !1 : G.j(a, b, c, d)
        },
        Ii = function(a) {
            var b = {};
            $d(165, Fi, function() {
        ...
        Hi = function(a, b) {
            ...
            if (c) 0 === ii && (ii = 1), ri(a.google_ad_client), Ei(a);
            else {
                0 === ii && (ii = 2);
                c = a.element;
                (a = a.params) && lc(a, function(a, c) {
                    b[c] = a
                });
                ...
                if (c) {
                    if (!li(c) && (c.id ? c = pi(c.id) : c = null, !c)) throw new S("'element' has already been filled.");
                    if (!("innerHTML" in c)) throw new S("'element' is not a good DOM element.");
                } else if (c = pi(), !c) throw new S("All ins elements in the DOM with class=adsbygoogle already have ads in them.");
                ni(c, b)
            }
        },
        Ki = function() {
        ...
        Ji = function() {
            var a = ic(hc(w)) || w;
            gg(a);
            Wd(B(w, le.w) || B(w, je.w) || B(w, je.U));
            $h();
            if (B(w, ue.Y) || B(w, ue.M) || B(w, ue.X) || B(w, ue.W)) Uh(), Rh("") && (X[1] = ""), B(w, ue.M) ? (a = ec(), Xh(a), Wh(a)) : Wh(null);
            if ((a = window.adsbygoogle) && a.shift) try {
                for (var b, c = 20; 0 < a.length && (b = a.shift()) && 0 < c;) Ii(b), --c
            } catch (d) {
                throw window.setTimeout(Ki, 0), d;
            }
            if (!a || !a.loaded) {
                B(w, we.u) && (b = Ce() ? Sa("", "pagead2.googlesyndication.com") : ac(), Oh(sc().document, b, "preconnect"));
                window.adsbygoogle = {
                    push: Ii,
                    loaded: !0
                };
